...
export const AMA_DEMO_SCRIPT: DemoStep[] = [
  {
    message: "Sold 3 bags of rice to Maame for 540 cedis",
    label: "Rice sale to Maame",
    emoji: "💚",
    preDelay: 1500,
    typeSpeed: 30,
  },
  {
    message: "Sold 2 crates of tomatoes for 160 cedis",
    label: "Tomato sale",
    emoji: "💚",
    preDelay: 2200,
    typeSpeed: 30,
  ...
  {
    message: "Sold 8 kg of onions for 96 cedis",
    label: "Onion sale",
    emoji: "💚",
    preDelay: 2200,
    typeSpeed: 30,
  ...
  {
    message: "Sold 5 bunches of plantains for 190 cedis",
    label: "Plantain sale to customer",
    emoji: "💚",
    preDelay: 2200,
    typeSpeed: 30,
  },
